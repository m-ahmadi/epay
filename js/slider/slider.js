...
$(function () {
	...
	$('#play-pause').on('click', function () {
		...
		if (el.hasClass('pause')) {
			el.css({background : 'url("images/slider/playh.png") no-repeat center'});
			el.removeClass('pause');
			el.addClass('play');
			autoplayOff();
		} else if (el.hasClass('play'))  {
			el.css({background : 'url("images/slider/pauseh.png") no-repeat center'});
			el.removeClass('play');
			el.addClass('pause');
			autoplayOn();
		}
	...
	$('#play-pause').on('mouseout', function () {
		var el = $(this);
		if (el.hasClass('pause')) {
			el.css({ background : 'url("images/slider/pause.png") no-repeat center'});
		} else if (el.hasClass('play'))  {
			el.css({background : 'url("images/slider/play.png") no-repeat center'});
		}
	});
});
